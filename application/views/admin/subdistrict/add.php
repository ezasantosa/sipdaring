			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('admin/subdistricts/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
					</div>
					<div class="card-body">
					<!-- <?php print_r($districts);?> -->
						<form action="<?php base_url('admin/subdistrict/add') ?>" method="post" enctype="multipart/form-data" >
							<div class="form-group">
								<label for="name">Desa/Kelurahan*</label>
								<input class="form-control <?php echo form_error('name') ? 'is-invalid':'' ?>"
								 type="text" name="name" placeholder="Nama Desa/Kelurahan" />
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('head_village') ? 'is-invalid':'' ?>"
								 type="text" name="head_village" placeholder=" Kepala Desa/Kelurahan"/>
								<div class="invalid-feedback">
